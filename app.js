...
app.use(helmet({
    contentSecurityPolicy: {
        directives: {
            defaultSrc: ["'self'", "https://soundmixerz-spcs-for-my-wbe-w-b-f-lol.nyc3.digitaloceanspaces.com"],
            scriptSrc: ["'self'", "https://cdn.plyr.io", "https://soundmixerz-spcs-for-my-wbe-w-b-f-lol.nyc3.digitaloceanspaces.com"],
            styleSrc: ["'self'", "https://cdn.plyr.io", 'https://fonts.googleapis.com', "https://cdnjs.cloudflare.com", "https://www.youtube.com", "https://www.youtube-nocookie.com", "https://soundmixerz-spcs-for-my-wbe-w-b-f-lol.nyc3.digitaloceanspaces.com"],
            mediaSrc: ["'self'", "blob:", "https://soundmixerz-spcs-for-my-wbe-w-b-f-lol.nyc3.digitaloceanspaces.com"],
            frameSrc: ["https://www.youtube.com", "https://www.youtube-nocookie.com", "https://soundmixerz-spcs-for-my-wbe-w-b-f-lol.nyc3.digitaloceanspaces.com"],
            imgSrc: ["'self'", "https://soundmixerz-spcs-for-my-wbe-w-b-f-lol.nyc3.digitaloceanspaces.com"],
        },
    },
}));
...
app.use((req, res, next) => {
  ...
  const s3 = new S3({
    ...
    credentials: {
      accessKeyId: 'DO00EJQMW33Y3P67XHXK', // Set in your environment
      secretAccessKey: 'hEl9VzMpLjHTFxpyzw0B9rOUHkPrSW0ojaNFMdk+Rco', // Set in your environment
    },
  });
  ...
  const upload = multer({
    storage: multerS3({
      s3: s3,
      bucket: 'soundmixerz-spcs-for-my-wbe-w-b-f-lol', // Replace with your space name
...
app.post('/SellBeat',upload.single('audioFile'), async (req, res) => {
    ...
    const data = await s3.listObjectsV2({
      Bucket: 'soundmixerz-spcs-for-my-wbe-w-b-f-lol',
    });
...
app.get('/Account', async (req, res) => {
    ...
    try{
        ...
        const bucketName = 'soundmixerz-spcs-for-my-wbe-w-b-f-lol'; 
        ...
        const PFP = result.pfp
            const data = await s3.listObjectsV2({
              ...
              console.log(foundFile.Key + ' FOUND FILE')
                ...
                const params = {
                    ...
                    console.log(url + " THIS IS THE URL WOOHOO")
                }
