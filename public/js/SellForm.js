...
document.querySelector('.products').classList.remove('filterBlur')
            ...
            if(data.message == 'No Stripe Account'){
                document.getElementById('LoadingOuter').style.display = 'none'
                document.querySelector('.products').classList.remove('filterBlur')
                                document.getElementById('ERROR').style.display = 'block'
                                document.getElementById('Errortxt').textContent = 'You Have Not Created a Stripe Connect Account'
                                document.getElementById('BPMbeatLabel').style.color = 'black'
                                document.getElementById('ContainLetterBPM').style.display = 'none'
                                 document.getElementById('BNlab').style.display = 'none'
                                 document.getElementById('BeatnameLabel').style.color = 'black'
...
window.onload = function(){
    ...
    if (window.location.href.includes("87453w4sekuyirgh5478936tyq3o9re4thgfekl")) {
       ...
       if (window.location.href.includes("DAW=pro")) {
...
.catch((err) => {
    console.log(err)
       ...
       } else if (window.location.href.includes("DAW=bas")) {
...
.then((data) => {
    ...
    if(data.message == 'Already Owned'){
        document.getElementById('ALO').style.overflow = 'hidden'
        document.getElementById('ALOtxt').style.textContent = 'You Already Own The Basic Package'
        document.getElementById('ALO').style.height = '100px'
        document.getElementById('ALO').style.transition = 'height .3s'
        setTimeout(function() {
            document.getElementById('ALO').style.overflow = 'hidden'
...
document.getElementById('TotTxt').textContent = 'Total: $7.00 Per Month'
...
document.getElementById('TotTxt').textContent = 'Total: $12.00 Per Month'
