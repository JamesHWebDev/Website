...
window.onload = function(){
        ...
        for(let i = 0; i < sec1.length; i++){
                sec1.forEach(sec1 => {
                        sec1.classList.add('animation')
                })
                sec1[i].style.opacity = '1'
                sec1[i].style.transition = 'opacity 2s'
        }
}
...
function handleScroll() {
    ...
    if (currentScroll >= fade2){
        ...
        for(let i = 0; i < sec2.length; i++){
                sec2.forEach(sec2 => {
                        sec2.classList.add('animation')
                })
                sec2[i].style.opacity = '1'
                sec2[i].style.transition = 'opacity 2s'
        }
    }
    if(currentScroll >= fade3) {
        ...
        for(let i = 0; i < sec3.length; i++){
                sec3.forEach(sec3 => {
                        sec3.classList.add('animation')
                })
                sec3[i].style.opacity = '1'
                sec3[i].style.transition = 'opacity 2s'
        }
    }
    if(currentScroll >= fade4){
        ...
        for(let i = 0; i < sec4.length; i++){
                sec4.forEach(sec4 => {
                        sec4.classList.add('animation')
                })
                sec4[i].style.opacity = '1'
                sec4[i].style.transition = 'opacity 2s'
        }
    }
    if(currentScroll >= fade5){
        ...
        for(let i = 0; i < sec5.length; i++){
                sec6.forEach(sec6 => {
                        sec6.classList.add('animation')
                })
                sec5[i].style.opacity = '1'
                sec5[i].style.transition = 'opacity 2s'
        }
    }
    if(currentScroll >= fade6){
        ...
        for(let i = 0; i < sec6.length; i++){
                ...
                sec6[i].style.transition = 'opacity 2s'
        }
    }
