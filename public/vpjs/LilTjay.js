...
window.onload = function(){
     document.getElementById('VocalPresetAdded').textContent = 'Lil Tjay Vocal Preset'
    document.getElementById('added').src = '/Images/Lil Tjay Image.jpg'
    document.getElementById('src').value = 'Images/Lil Tjay Image.jpg'
    document.getElementById('VPInp').value = 'LilTjay Vocal Preset'
    document.getElementById('BVP').value = 'LilTjay Vocal Preset'
    document.getElementById('Wvpbr').value = '9'
    document.getElementById('SCNum').value = '9'
    const logplugin = document.createElement('li')
