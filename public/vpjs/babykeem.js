...
var DAW = JSON.parse(localStorage.getItem("artistDAW"))
var payment = JSON.parse(localStorage.getItem("payment"));
var fullpayment = +localStorage.getItem("fullpayment")
var artist = JSON.parse(localStorage.getItem("artistitem"))
var removelist = JSON.parse(localStorage.getItem("removelist"))
var username = localStorage.getItem("username")
var x = localStorage.getItem("shoppingcartnum");
...
window.onload = function(){
    document.getElementById('VocalPresetAdded').textContent = 'Frank Ocean Vocal Preset'
    document.getElementById('added').src = '/Images/FrankOcean.jpg'
    document.getElementById('src').value = 'Images/FrankOcean.jpg'
    document.getElementById('VPInp').value = 'Frank Ocean Vocal Preset'
    document.getElementById('BVP').value = 'Frank Ocean Vocal Preset'
document.getElementById('Wvpbr').value = '5'
document.getElementById('SCNum').value = '5'
    const logplugin = document.createElement('li')
