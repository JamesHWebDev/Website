...
window.onload = function(){
    document.getElementById('VocalPresetAdded').textContent = 'Lil Uzi Vert Vocal Preset'
    document.getElementById('added').src = '/Images/Lil Uzi Vert.jpg'
    document.getElementById('src').value = 'Images/Lil Uzi Vert.jpg'
    document.getElementById('VPInp').value = 'Lil Uzi Vert Vocal Preset'
    document.getElementById('BVP').value = 'Lil Uzi Vert Vocal Preset'
    document.getElementById('Wvpbr').value = '12'
    document.getElementById('SCNum').value = '12'
