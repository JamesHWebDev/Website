...
window.onload = function(){
    document.getElementById('VocalPresetAdded').textContent = 'Travis Scott Vocal Preset'
    document.getElementById('added').src = '/Images/Travis Scott Image.jpg'
    document.getElementById('src').value = 'Images/Travis Scott Image.jpg'
    document.getElementById('VPInp').value = 'TravisScott Vocal Preset'
    document.getElementById('BVP').value = 'TravisScott Vocal Preset'
    document.getElementById('Wvpbr').value = '8'
    document.getElementById('SCNum').value = '8'
    const logplugin = document.createElement('li')
...
function SeeMorePresets(){
    
    for(let i = 0; i < MorePresets.length;i++){
        if(MorePresets[i].style.display == 'block'){
            MorePresets[i].style.display = 'none'
            SeeMore.textContent = "V"
        }
        else{
            MorePresets[i].style.display = 'block'
            SeeMore.textContent = "Λ"
        }
