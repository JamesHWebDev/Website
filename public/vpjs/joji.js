...
window.onload = function(){
    document.getElementById('VocalPresetAdded').textContent = 'Bryson Tiller Vocal Preset'
    document.getElementById('added').src = '/Images/BrysonTiller.jpg'
    document.getElementById('src').value = 'Images/BrysonTiller.jpg'
    document.getElementById('VPInp').value = 'Bryson Tiller Vocal Preset'
    document.getElementById('BVP').value = 'Bryson Tiller Vocal Preset'
document.getElementById('Wvpbr').value = '7'
document.getElementById('SCNum').value = '7'
    const logplugin = document.createElement('li')
