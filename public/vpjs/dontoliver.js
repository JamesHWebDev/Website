...
window.onload = function(){
    ...
    document.getElementById('VocalPresetAdded').textContent = 'Don Toliver Vocal Preset'
    document.getElementById('added').src = '/Images/Don-Toliver.webp'
    document.getElementById('src').value = 'Images/Don-Toliver.webp'
    document.getElementById('VPInp').value = 'DonToliver Vocal Preset'
    document.getElementById('BVP').value = 'DonToliver Vocal Preset'
document.getElementById('Wvpbr').value = '6'
document.getElementById('SCNum').value = '6'
    const logplugin = document.createElement('li')
...
// Check if the query parameter "success" exists and is true
const success = urlParams.get('success=true');

console.log(urlParams.value)

if (window.location.href.includes("87453w4sekuyirgh5478936tyq3o9re4thgfekl")) {
   
   console.log('PASSED')
  

if(window.location.href.includes("DAW=fl")){
  
    const form = document.getElementById("BuyVPForm");
...
function priceChange(){
    optionValue = dropdown.options[dropdown.selectedIndex].value;
    if(optionValue == "Select DAW"){
        DAWname.textContent = "";
        price.textContent ="";
        price1.textContent = "";
        list.innerHTML = ''
    ...
    if (optionValue == "30"){
            ...
            price1.textContent = "$30" + ".00";
            DAWname.textContent = "Wave";

    }
    else if(optionValue == "Logic Pro X"){
        price.textContent = "$20" + ".00";
        price1.textContent = "$20" + ".00";
        DAWname.textContent = "Logic Pro X";
        list.innerHTML = ''
    ...
    else if(optionValue == "Pro Tools"){
        price.textContent = "$20" + ".00";
        price1.textContent = "$20" + ".00";
        DAWname.textContent = "Pro Tools";
    }
    else if(optionValue == "Band Lab"){
        price.textContent = "$20" + ".00";
        price1.textContent = "$20" + ".00";
        DAWname.textContent = "Band Lab";
    }
} 
