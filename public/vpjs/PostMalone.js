...
window.onload = function(){
    document.getElementById('VocalPresetAdded').textContent = 'Post Malone Vocal Preset'
    document.getElementById('added').src = '/Images/Post Malone.jpg'
    document.getElementById('src').value = '/Images/Post Malone.jpg'
    document.getElementById('VPInp').value = 'Post Malone Vocal Preset'
    document.getElementById('BVP').value = 'Post Malone Vocal Preset'
