...
window.onload = function(){
     document.getElementById('VocalPresetAdded').textContent = 'Brent Faiyaz Vocal Preset'
    document.getElementById('added').src = '/Images/Brent Faiyaz.jpg'
    document.getElementById('src').value = 'Images/Brent Faiyaz.jpg'
    document.getElementById('VPInp').value = 'Brent Faiyaz Vocal Preset'
    document.getElementById('BVP').value = 'Brent Faiyaz Vocal Preset'
