...
window.onload = function(){
    document.getElementById('VocalPresetAdded').textContent = 'YNW Melly Vocal Preset'
    document.getElementById('added').src = '/Images/ynw melly.jpg'
    document.getElementById('src').value = 'Images/ynw melly.jpg'
    document.getElementById('VPInp').value = 'YNW Melly Vocal Preset'
    document.getElementById('BVP').value = 'YNW Melly Vocal Preset'
