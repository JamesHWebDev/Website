...
window.onload = function(){
    document.getElementById('VocalPresetAdded').textContent = 'The Weeknd Vocal Preset'
    document.getElementById('added').src = '/Images/The Weekend.jpg'
    document.getElementById('src').value = 'Images/The Weekend.jpg'
    document.getElementById('VPInp').value = 'TheWeeknd Vocal Preset'
    document.getElementById('BVP').value = 'TheWeeknd Vocal Preset'
