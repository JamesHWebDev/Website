...
window.onload = function(){
    document.getElementById('VocalPresetAdded').textContent = 'Ken Carson Vocal Preset'
    document.getElementById('added').src = '/Images/KenCarson.jpg'
    document.getElementById('src').value = 'Images/KenCarson.jpg'
    document.getElementById('VPInp').value = 'Ken Carson Vocal Preset'
    document.getElementById('BVP').value = 'Ken Carson Vocal Preset'
document.getElementById('Wvpbr').value = '3'
document.getElementById('SCNum').value = '3'
    const logplugin = document.createElement('li')
