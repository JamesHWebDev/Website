...
window.onload = function(){
    document.getElementById('VocalPresetAdded').textContent = 'Destroy Lonely Vocal Preset'
    document.getElementById('added').src = '/Images/DestroyLonely.jpg'
    document.getElementById('src').value = 'Images/DestroyLonely.jpg'
    document.getElementById('VPInp').value = 'Destroy Lonely Vocal Preset'
    document.getElementById('BVP').value = 'Destroy Lonely Vocal Preset'
        document.getElementById('Wvpbr').value = '2'
        document.getElementById('SCNum').value = '2'
    const logplugin = document.createElement('li')
