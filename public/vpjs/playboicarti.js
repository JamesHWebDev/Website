...
window.onload = function(){
    document.getElementById('VocalPresetAdded').textContent = 'PlayBoiCarti Vocal Preset'
    document.getElementById('added').src = '/Images/PlayBoi Carti.jpg'
    document.getElementById('src').value = 'Images/PlayBoi Carti.jpg'
    document.getElementById('VPInp').value = 'PlayBoiCarti Vocal Preset'
    document.getElementById('BVP').value = 'PlayBoiCarti Vocal Preset'
