...
window.onload = async function(){
    ...
    document.getElementById('VocalPresetAdded').textContent = 'Autumn! Vocal Preset'
    document.getElementById('added').src = '/Images/Autumn!.jpg'
    document.getElementById('src').value = 'Images/Autumn!.jpg'
    document.getElementById('VPInp').value = 'Autumn! Vocal Preset'
    document.getElementById('BVP').value = 'Autumn! Vocal Preset'
    document.getElementById('Wvpbr').value = '1'
document.getElementById('SCNum').value = '1'
    const logplugin = document.createElement('li')
