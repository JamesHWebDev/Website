...
window.onload = function(){
    document.getElementById('VocalPresetAdded').textContent = 'The Kid LAROI Vocal Preset'
    document.getElementById('added').src = '/Images/TheKidLaroi.jpg'
    document.getElementById('src').value = 'Images/TheKidLaroi.jpg'
    document.getElementById('VPInp').value = 'The Kid LAROI Vocal Preset'
    document.getElementById('BVP').value = 'The Kid LAROI Vocal Preset'
    document.getElementById('Wvpbr').value = '11'
    document.getElementById('SCNum').value = '11'
    const logplugin = document.createElement('li')
