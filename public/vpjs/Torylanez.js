...
window.onload = function(){
     document.getElementById('VocalPresetAdded').textContent = 'Tory Lanez Vocal Preset'
    document.getElementById('added').src = '/Images/Tory Lanez.jpg'
    document.getElementById('src').value = 'Images/Tory Lanez.jpg'
    document.getElementById('VPInp').value = 'ToryLanez Vocal Preset'
    document.getElementById('BVP').value = 'ToryLanez Vocal Preset'
document.getElementById('Wvpbr').value = '4'
document.getElementById('SCNum').value = '4'
    const logplugin = document.createElement('li')
