...
window.onload = function(){
    document.getElementById('VocalPresetAdded').textContent = 'Trippie Redd Vocal Preset'
    document.getElementById('added').src = '/Images/Trippie Redd.jpg'
    document.getElementById('src').value = 'Images/Trippie Redd.jpg'
    document.getElementById('VPInp').value = 'Trippie Redd Vocal Preset'
    document.getElementById('BVP').value = 'Trippie Redd Vocal Preset'
